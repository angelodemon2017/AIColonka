...
namespace sc.modeling.splines.editor
{
    ...
    public class VertexColorTool : EditorTool
    {
        ...
        {
            return Resources.Load<Texture2D>("spline-mesher-color-icon-64px");
        }
        ...
        void OnEnable()
        {
            ...
            Shader vertexColorShader = Resources.Load<Shader>("VisualizeVertexColors");
        ...
        public override void OnToolGUI(EditorWindow window)
        {
            foreach (var m_target in targets)
            {
                ...
                if (visualizationChannel != VisualizationChannel.None)
                {
                    ...
                    vertexColorMaterial.SetFloat("_Channel", channel);
